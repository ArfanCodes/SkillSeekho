  ...
  return (
    <div className="min-h-screen px-6 py-14">
      <div className="max-w-xl mx-auto">
        ...
        {/* Logout */}
        <button className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl text-red-500 font-semibold text-sm border border-red-100 bg-white hover:bg-red-50 transition-colors">
