...
const TRENDING = ['Biryani Making', 'Spoken English', 'Guitar', 'Yoga', 'Photography', 'Tailoring'];
...
export default function Discover() {
  return (
    <div className="min-h-screen py-14">
      ...
      <div className="mb-12">
        <SkillCarousel skills={skillCategories} title="Explore Categories" subtitle="Browse by skill type" />
      </div>
