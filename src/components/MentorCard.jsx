...
import { Star, MapPin, ShieldCheck, Heart, BadgeCheck } from 'lucide-react';

export default function MentorCard({ mentor, index = 0 }) {
  const {
    name, avatar, avatarColor, skill, distance, rating,
    reviews, vouches, pricePerSession, currency, verified,
    location: loc, tags,
  } = mentor;
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {verified && (
              <BadgeCheck size={15} className="text-green-500 flex-shrink-0" fill="#22C55E" color="white" />
            )}
          </div>
