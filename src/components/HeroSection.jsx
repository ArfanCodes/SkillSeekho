...
export default function HeroSection() {
  ...
  const handleVoice = () => {
    setListening((v) => !v);
    // Browser SpeechRecognition hook would go here
  };
  ...
  return (
    <section className="relative overflow-hidden px-6 py-16 md:py-24">
      ...
      />
      <div
        className="absolute -bottom-24 -left-24 w-96 h-96 rounded-full opacity-8 pointer-events-none"
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="flex items-center bg-white rounded-2xl shadow-lg p-2 mb-6 max-w-xl mx-auto"
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.92 }}
            className={`
              flex items-center justify-center w-10 h-10 rounded-xl mr-1 transition-all
              ${listening
